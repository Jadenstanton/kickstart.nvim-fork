...
do
  ...
  -- Harpoon - navigate across up to 4 different files
  vim.pack.add { gh 'nvim-lua/plenary.nvim', { src = gh 'ThePrimeagen/harpoon', version = 'harpoon2' } }
...
do
  ...
  vim.list_extend(ensure_installed, { 'black' })
